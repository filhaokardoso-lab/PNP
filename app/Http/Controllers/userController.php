...
class UserController extends Controller
{
        ...
        //Mostrar a lista List pela páginas
        ...
        public function index (Request $request){
            ...
            ->paginate(5)  // Pagina os resultados, exibindo 20 por página
...
public function update(UserRequest $request, User $user)
{
    ...
    $imageName = $user->image; // manter imagem atual por padrão
    ...
    if ($request->filled('roles')) {
        $user->syncRoles([$request->roles]); // substitui todos os perfis existentes pelo novo
    }
...
public function store(UserRequest $request)
{
    ...
    // Atribui o perfil selecionado no formulário
    if ($request->filled('roles')) {
